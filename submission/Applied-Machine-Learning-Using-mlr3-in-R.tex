...
\include{chapters/chapter1/introduction_and_overview.tex}

\part{Fundamentals}

\include{chapters/chapter2/data_and_basic_modeling.tex}
\include{chapters/chapter3/evaluation_and_benchmarking.tex}

\part{Tuning and Feature Selection}

\include{chapters/chapter4/hyperparameter_optimization.tex}
\include{chapters/chapter5/advanced_tuning_methods_and_black_box_optimization.tex}
\include{chapters/chapter6/feature_selection.tex}

\part{Pipelines and Preprocessing}

\include{chapters/chapter7/sequential_pipelines.tex}
\include{chapters/chapter8/non-sequential_pipelines_and_tuning.tex}
\include{chapters/chapter9/preprocessing.tex}

\part{Advanced Topics}

\include{chapters/chapter10/advanced_technical_aspects_of_mlr3.tex}
\include{chapters/chapter11/large-scale_benchmarking.tex}
\include{chapters/chapter12/model_interpretation.tex}
\include{chapters/chapter13/beyond_regression_and_classification.tex}
\include{chapters/chapter14/algorithmic_fairness.tex}
