...
In Section @sec-resampling we will learn how `r mlr3book::mlr_pkg("mlr3")` can automatically create training and test sets based on different [resampling](#resampling) strategies.
