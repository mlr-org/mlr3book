...
rsmp_custom$instantiate(task_penguins,
  list(which(task_penguins$data()$island != "Biscoe")),
  list(which(task_penguins$data()$island == "Biscoe"))
)
...
tune(tnr_random, task_penguins, learner, rsmp_custom, msr_ce, 10)
```
...
```{r optimization-038}
instance = tune(tnr_random, task_penguins, learner, rsmp_custom, msr_ce, 10)
