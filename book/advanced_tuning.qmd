...
cvcust = rsmp("custom")
cvcust$instantiate(task_pen,
  list(which(task_pen$data()$island != "Biscoe")),
  list(which(task_pen$data()$island == "Biscoe"))
)
...
tune(rnd_srch, task_pen, learner, cvcust, msr_ce, 10)
```
...
```{r optimization-038}
instance = tune(rnd_srch, task_pen, learner, cvcust, msr_ce, 10)
