# Feature Selection / Filtering {#fs .unnumbered}
...
Similar to other instances in `r mlr3book::mlr_pkg("mlr3")`, these are registered in a dictionary (`r ref("mlr_filters")`) with an associated shortcut function `r ref("flt()")`.
