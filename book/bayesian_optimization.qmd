...
<!--
#FIXME: args, result assigner, maybe in a callout note?
-->
...
Moreover, note during construction of the `r ref("OptimizerMbo")` passing arguments such as `archive` to the `surrogate` is no longer required because we now work with an `r ref("OptimizerMbo")` directly instead of the building blocks.
