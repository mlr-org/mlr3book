...
abstract:
  ...
  Starting with the general black-box optimization setting, we introduce the building blocks of Bayesian optimization, a class of sample-efficient iterative global optimization algorithms that are very stuited for tackling black-box optimization problems.
  ...
  We then briefly discuss handling noisy objective functions and parallelizing Bayesian optimization as well as robustness and further provide practical considerations for using and implementing Bayesian optimization algorithms.
