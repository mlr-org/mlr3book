...
`r ref("OptimizerMbo")` refers to BO as introduced in this chapter.
...
ggplot() +
  ...
  scale_y_continuous("y", sec.axis = sec_axis(~ . * 0.025, name = "EI",
...
The optimizer's objective is to identify the most promising points for evaluation by maximizing the acquisition function within a limited computational budget.
