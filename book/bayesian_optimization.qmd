...
abstract:
  ...
  Starting with the general black-box optimization setting, we introduce the building blocks of Bayesian optimization, a class of sample-efficient iterative global optimization algorithms that are very suited for tackling black-box optimization problems.
