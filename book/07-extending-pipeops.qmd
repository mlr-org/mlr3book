...
```{r 07-extending-pipeops-002, echo=FALSE}
...
```{r 07-extending-pipeops-003, eval = FALSE, tidy = FALSE}
...
```{r 07-extending-pipeops-004, eval = FALSE}
initialize = function(id = "copy.two") {
...
```{r 07-extending-pipeops-007, tidy = FALSE}
PipeOpCopyTwo = R6::R6Class("PipeOpCopyTwo",
  inherit = mlr3pipelines::PipeOp,
  public = list(
    initialize = function(id = "copy.two") {
...
```{r 07-extending-pipeops-009, tidy = FALSE}
...
```{r 07-extending-pipeops-012, tidy = FALSE}
...
```{r 07-extending-pipeops-014, tidy = FALSE}
...
```{r 07-extending-pipeops-019, tidy = FALSE}
...
```{r 07-extending-pipeops-026, error = TRUE}
