...
A good first introduction to machine learning is ["An Introduction to Statistical Learning"](https://www.statlearning.com/) by James, Witten, Hastie, and Tibshirani; it fits particularly well since it has code examples in R (albeit not using `mlr3`).

Another option that covers fewer actual ML algorithms, and instead focuses more on the learning problem itself, is ["Learning From Data"](https://amlbook.com/) by Abu-Mostafa, Magdon-Ismail, and Lin, which is the acompanying book of the [free Caltech "Learning from Data" online course](https://work.caltech.edu/telecourse).
