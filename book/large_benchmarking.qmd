...
warning_ids = grepLogs(ids = findDone(), pattern = "warning", ignore.case = TRUE, fixed = TRUE)

# overview: which tasks / learners have warnings?
summarizeExperiments(warning_ids, by = c("problem", "algorithm", "learner_id"), reg = reg)

# example log
writeLines(getLog(warning_ids[1]))
```
