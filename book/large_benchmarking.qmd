...
```{r large_benchmarking-029, echo = FALSE}
#| cache: false
library(batchtools)
...
We test the job with `job.id = 1` and specify `external = TRUE` to run the test in an external R session.
