...
We create a registry in a temporary directory - usually you would store it in a subdirectory of your home dir which is shared via a network file system.
...
# temporary directory where all files are stored
file.dir = tempfile()
