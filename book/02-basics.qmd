...
* access the set of [classification and regression learners](#predefined-learners) that come with `r mlr3book::mlr_pkg("mlr3")` and retrieve a specific learner (more types of learners are covered later in the book),
...
## Train and predict {#sec-basics-train-predict}
