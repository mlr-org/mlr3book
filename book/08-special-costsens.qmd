# Cost-Sensitive Classification {#cost-sens .unnumbered}
...
For our first model, we choose an ordinary logistic regression (implemented in add-on package `r mlr3book::mlr_pkg("mlr3learners")`).
...
This allows us to tune the `thresholds` via an outside optimizer from `r mlr3book::mlr_pkg("mlr3tuning")`.
