...
## Extending `PipeOp` Class {#sec-extending-pipeops}
...
### General Case Example: `PipeOpCopy` {#sec-ext-pipeopcopy}
...
### Special Case: Preprocessing {#sec-ext-pipe-preproc}
...
### Hyperparameters {#sec-ext-pipe-hyperpars}
...
## Extending `Tuner` Class {#sec-extending-tuners}
...
### Adding a new Tuner {#sec-extending-tuners-summary}
...
### Optimize method {#sec-tuner-optimize}
...
### Assign result method {#sec-tuner-add-result}
...
### Transform optimizer to tuner {#sec-tuner-from-optimizer}
