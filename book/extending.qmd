...
In this chapter we will cover how to extend the two basic classes of the `r mlr3` universe: `r ref("Measure")` and `r ref("Leaner")`.
...
In maths this would be defined as $f(y, \hat{y}) = \frac{\sum_{i=1}^n \mathbb{I}(|y_i - \hat{y}_i| < \sigma(y))}{n}$.
As an aggregate measure, we would then take the mean of this score over all predictions.
...
This measure is then bounded between [1, 0] where a larger score is better.
  ...
  public = list(
    initialize = function() { # initialize class
      super$initialize(
        ...
        minimize = FALSE # optimised at maximum
      )
    }
  ),
...
<!-- TODO - Sebastian please make sure this is included in the main text. -->
...
<!-- TODO - Sebastian please make sure this is included in the vignette. -->
