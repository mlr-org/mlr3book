...
In this chapter we will cover how to extend the two basic classes of the `r mlr3` universe: `r ref("Learner")` and `r ref("Measure")`.
We will start with extending learners (@sec-extending-learners) and then move on to measures (@sec-extending-measures), both in the context of regression, but this extends to any other machine learning task.
