...
* `predict_types`: Set of predict types the learner supports.
  These differ depending on the type of the learner. See `r ref("mlr_reflections")` for the full list of predict types supported by `r mlr3`.
...
* `feature_types`: Set of feature types the learner is able to handle.
  See `r ref("mlr_reflections")` for feature types supported by `r mlr3`.
* `properties`: Set of properties of the learner. See `r ref("mlr_reflections")` for the full list of learner properties supported by `r mlr3`.
