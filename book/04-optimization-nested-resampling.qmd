...
```{r 04-optimization-nested-resampling-001, include = F}
library(mlr3)
library(mlr3book)
```
...
```{r 04-optimization-nested-resampling-002, echo = FALSE, out.width="98%"}
...
```{r 04-optimization-nested-resampling-003}
library("mlr3verse")
...
```{r 04-optimization-nested-resampling-004}
task = tsk("pima")
...
```{r 04-optimization-nested-resampling-005}
...
```{r 04-optimization-nested-resampling-006}
rr$score()
```
...
```{r 04-optimization-nested-resampling-007}
rr$aggregate()
```
...
```{r 04-optimization-nested-resampling-008}
at$train(task)
```
