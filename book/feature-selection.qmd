...
There are different approaches to identifying relevant features, we will focus on two methods:

**Filters**

[Filter](#fs-filter) algorithms select features by asigning numeric scores to each feature.
