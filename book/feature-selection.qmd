...
filter_cor$param_set$set_values(method = "spearman")
...
# now it can be used like any learner, but it includes the feature selection
...
Note that `fselect` directly starts the optimization and selects features.
