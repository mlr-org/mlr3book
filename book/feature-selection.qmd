...
* Correlation (`r ref("FilterCorrelation")`)
* Variance (`r ref("FilterVariance")`)
* Information gain (`r ref("FilterInformationGain")`)
* Minimal joint Mutual information maximization (`r ref("FilterJMIM")`)
* Permutation score (`r ref("FilterPermutation")`)
* Area under the ROC curve (`r ref("FilterAUC")`)
...
There is a list of all implemented filter methods on the `r link("https://mlr3filters.mlr-org.com", "mlr3filters website")`, which also shows the supported task and features types.
