...
There are different approaches to identifying relevant features, we will focus on two approaches, which are described in detail below: [Filter](#fs-filter) and [Wrapper](#fs-wrapper) methods [@guyon2003;@chandrashekar2014].
...
A third alternative are [embedded methods](#fs-embedded-methods).
