...
4. Automate the feature selection as in @sec-autofselect with the `spam` dataset and a logistic regression learner (`lrn("classif.log_reg")`). Hint: Remember to call `library("mlr3learners")` for the logistic regression learner.
