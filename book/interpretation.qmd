...
We will only provide a brief overview to the methods discussed below, we recommend @Molnar22 as a comprehensive introductory book about interpretable ML.
...
cfe = whatif$find_counterfactuals(steve,
  desired_class = "good", desired_prob = c(0.8, 1))
