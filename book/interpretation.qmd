...
::: {.callout-tip}
Shapley values can take a long time to compute. This process can be sped up at the expense of accuracy. The parameters `B` and `N` can be used to tune this trade-off.
:::

#### Ceteris Paribus Effects

In the previous section, we have introduced a global explanation -- Partial Dependence plots. Ceteris Paribus plots are the local version of that explanation. It shows the response of a model when only one feature is changed while others stay unchanged. Read more about this technique in the chapter *Ceteris Paribus* of [EMA book](https://ema.drwhy.ai/). 
