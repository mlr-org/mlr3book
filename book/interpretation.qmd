...
The `r ref_pkg("DALEX")` package implements the most common methods for explaining predictive models using post-hoc model agnostic techniques. You can use this package for any model built with the `r ref_pkg("mlr3")` package as well as with other frameworks in R [@Biecek2018] or Python [@Baniecki2021].
