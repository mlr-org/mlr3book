...
In fact, `r ref_pkg("iml")` supports ML models (for classification or regression) fitted by *any* R package.
This is possible by wrapping fitted models in an `r ref("iml::Predictor")` object to unify the input-output behavior of the trained models.
