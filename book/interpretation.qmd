...
According to @sec-performance, performance evaluation should not be conducted on the training data but on hold-out/test data to receive unbiased estimates for the performance. 
