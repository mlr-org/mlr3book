...
```{r interpretation-012, echo=FALSE, fig.cap='Taxonomy of methods for model exploration presented in this chapter. Left part overview methods for instance level exploration while right part is related to dataset level model exploration.', out.width = '92%', fig.align='center'}
...
```{r interpretation-013, message=FALSE, warning=FALSE}
library("DALEX")
...
```{r interpretation-014, message=FALSE, warning=FALSE}
dim(fifa)
```
...
```{r interpretation-015, message=FALSE, warning=FALSE}
...
```{r interpretation-016, message=FALSE, warning=FALSE}
library("mlr3")
library("mlr3learners")
```
...
```{r interpretation-017, message=FALSE, warning=FALSE}
...
```{r interpretation-018, message=FALSE, warning=FALSE}
...
```{r interpretation-021, message=FALSE, warning=FALSE, echo=FALSE}
