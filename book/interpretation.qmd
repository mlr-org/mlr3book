...
```{r, interpretation--0006-model, message=FALSE,warning=FALSE}
...
```{r interpretation-whatifparallel, message=FALSE, warning=FALSE, fig.height=3.5, out.width = '80%', fig.align='center'} 
...
To see how the features have been changed and to assess whether the proposed features changes are minimal, we can visualize the counterfactuals on a 2-dim ICE plot, also called a surface plot.
