...
The `$find_counterfactuals()` method generates a counterfactual of class  `r ref("counterfactuals::Counterfactuals")`, which assumes a 0.7 threshold for landing in the `good` class.
