...
In the following, we focus on using hold-out/test data to assess model interpretation.^[Cross-validation is recommended over hold-out splitting (see @sec-performance), but how to conduct cross-validation for the purpose of interpretation is an open question.]
