...
We have seen that during task creation, certain columns are designated as targets and features, their "roles":
...
Columns can have have multiple roles. It is also possible for a column to have no role at all, in which case they are ignored.
