...
: Hyperparameter configurations in each stage and bracket from schedule in @tbl-hyperband. Entries are identifiers for different hyperparameter configurations. $HPC^*_s$ is the optimal hyperparameter configuration in bracket $s$ and $HPC^*$ is the optimal hyperparameter configuration across all brackets. {#tbl-hyperband-eg}
