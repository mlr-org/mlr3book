...
There are multiple `r ref("Tuner")`\index{Tuner}[Tuner]{.aside} classes in `mlr3tuning`, which implement different HPO (or more generally speaking `r index('black-box optimization')`) algorithms (@tbl-tuners).
