...
The section [Tuning Spaces](#sec-tuning-spaces) introduces the `r mlr3book::mlr_pkg("mlr3tuningspaces")` extension package which is a collection of search spaces from scientific articles.
