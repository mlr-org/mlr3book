...
abstract:
  ...
  Finally, we also show how to optimize multiple measures simultaneously using multi-objective optimization techniques and further illustrate how multi-fidelity optimization can be performed.
---
...
This process is repeated with multiple configurations and the configuration with the best estimated performance is selected.
