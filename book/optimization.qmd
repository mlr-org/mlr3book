...
Finally, we can set `store_models = FALSE` in the `r ref("resample()")` or `r ref("bmr")` functions to disable the storage of the auto tuners when running nested resampling.
