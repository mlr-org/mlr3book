...
We see that the measured performance significantly overestimates the performance of the tuned model.
...
Nested resampling estimate a classification error of 10.8%.
