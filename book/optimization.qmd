...
In this case special case, the `.extra_trafo` must return a list with a single element, because it corresponds to a single hyperparameter that is being tuned.
