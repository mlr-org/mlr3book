...
Since the tuner automatically suggests configurations, we cannot completely control the process and there should be no interruptions.
...
The `r ref_pkg("evaluate")` catches any errors that occur and allows the process to continue.
...
We will now explain in more detail how a search space is created from a Learner.
...
It is possible to specify dependencies between parameters.
