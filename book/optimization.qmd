...
Later we use these objects to [construct the tuning instance](#sec-tuning-instance).
...
The best hyperparameter settings and the corresponding measured performance are stored in `$result`.
