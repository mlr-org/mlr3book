...
The goal of [hyperparameter optimization](#sec-model-tuning) (HPO) (see @sec-model-tuning) or model tuning is to find the optimal configuration of hyperparameters of an ML algorithm for a given task.
