...
abstract:
  Hyperparameters are an essential part of configuring machine learning algorithms, as they can significantly influence the behavior of the resulting model.
  ...
  We discuss more advanced topics like fallback learners and encapsulation during training and prediction and the design of search spaces.
  Finally, we illustrate how multi-fidelity optimization can be performed to use optimization resources more efficiently and we further show how to optimize multiple measures simultaneously using multi-objective optimization techniques.
---
