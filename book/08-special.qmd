# Special Tasks {#sec-special-tasks .unnumbered}

This chapter explores the different functions of `r mlr3book::mlr_pkg("mlr3")` when dealing with specific data sets that require further statistical modification to undertake sensible analysis.
...
See `r mlr3book::gh_pkg("mlr-org/mlr3ordinal")` for the current state.
...
Steps on how to accommodate functional data structures in`r mlr3book::mlr_pkg("mlr3")`are explained in the [functional analysis](#functional) sub-chapter.
...
Instructions on how to deal with [multilabel classification](#multilabel) in`r mlr3book::mlr_pkg("mlr3")`can be found in this sub-chapter.
...
This sub-chapter explains how to perform [cluster analysis](#cluster) in`r mlr3book::mlr_pkg("mlr3")`with the help of `mlr3cluster` extension package.
