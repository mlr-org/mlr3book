...
```{r 08-special-001, echo = FALSE, message = FALSE}
library("data.table")
library("mlr3")
library("mlr3book")
...
```{r 08-special-002, include = FALSE}
library(mlr3proba)
...
```{r 08-special-007, include = FALSE}
library(mlr3proba)
library(mlr3extralearners)
library(mlr3viz)
```
...
```{r 08-special-011, include = FALSE}
...
```{r 08-special-041, message=FALSE, warning=FALSE}
library("mlr3")
library("mlr3cluster")
library("mlr3viz")
set.seed(1L)
...
```{r 08-special-042, message=FALSE, warning=FALSE}
...
```{r 08-special-043, message=FALSE, warning=FALSE}
...
```{r 08-special-044, message=FALSE, warning=FALSE}
...
```{r 08-special-045, message=FALSE, warning=FALSE}
learner = lrn("clust.kmeans")
