...
```
Bischl B, Sonabend R, Kotthoff L, Lang M. `r strftime(Sys.Date(), "%Y")`. "{{< meta title >}}". https://mlr3book.mlr-org.com.
...
```
Chapter Author Surname(s) and Initial(s). `r strftime(Sys.Date(), "%Y")`. "Title of Chapter", in Bischl B, Sonabend R, Kotthoff L, Lang M, (ed[s]) *{{< meta title >}}*. https://mlr3book.mlr-org.com.
