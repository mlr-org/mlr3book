...
We used automated tuning to optimize the number of trees in the random forest learner (@sec-optimization) and a machine learning pipeline that imputes missing data, collapses factor levels, and creates stacked models (@sec-pipelines).
...
Please make sure you read our `r link("https://github.com/mlr-org/mlr3/blob/main/.github/CODE_OF_CONDUCT.md", "code of conduct")` and `r link("https://github.com/mlr-org/mlr3/blob/main/CONTRIBUTING.md", "contribution guidelines")` to keep our community friendly and safe!
