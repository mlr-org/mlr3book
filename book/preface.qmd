...
In this (much more complex!) example we chose two tasks and two machine learning (ML) algorithms ("learners" in `mlr3` terms).
...
:::{.callout-tip}
As you work through this book you may notice the difference between `mlr3` and `r mlr3`.
The former refers to the universe of packages whereas the latter specifically refers to the package `r mlr3` which provides the core infrastructure for all other packages in the universe.
:::
...
Throughout the book we will reference `mlr3`
