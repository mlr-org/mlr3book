...
Steps on how to accommodate functional data structures in`r mlr_pkg("mlr3")`are explained in the [functional analysis](#functional) sub-chapter.
...
![`r cran_pkg("mlr3spatial")` parallel spatial prediction benchmark](https://mlr3spatial.mlr-org.com/dev/articles/plot-benchmark-1.png){fig-align="center"}
