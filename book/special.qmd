...
The plots include a dotted line which visualises the average silhouette coefficient across all data points and each data point’s silhouette value is represented by a bar coloured by cluster.
