...
Therefore, separate test data is used to evaluate models in an unbiased way and assess to what extent they have learned the relationships that underlie the data, i.e., tests how well the model makes predictions (@sec-predicting) on new data as an estimate of future performance.
