...
These building blocks include the data (and the methods of creating training and testing sets), the machine learning algorithm (and its training and prediction process), and evaluation measures for predictions.
