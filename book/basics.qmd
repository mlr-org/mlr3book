...
In @sec-cost-sens we will look at `r index('cost-sensitive classification')` where each class has a different associated cost and how to automatically choose and set thresholds,§ and i
