...
We generally recommend converting names with `r ref("make.names()")` first, but if you are feeling lucky you can also set the option `mlr3.allow_utf8_names` to true to relax the check.
:::
