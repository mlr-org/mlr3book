...
```{r 06-technical-001, echo = FALSE, message = FALSE}
library("data.table")
library("mlr3")
library("mlr3book")
...
```{r 06-technical-022, message = FALSE}
# load data
...
```{r 06-technical-038, R.options=list(width = 120)}
as.data.table(parA)
```
...
```{r 06-technical-042, R.options=list(width = 120)}
as.data.table(ps)
```
...
```{r 06-technical-055, echo = FALSE, out.width="45%", fig.show = "hold", fig.width = 4, fig.height = 4}
#| layout: [[40, 40]]
par(mar=c(4, 4, 2, 1))
...
```{r 06-technical-074, eval = knitr::is_html_output()}
