# Density Estimation {#density .unnumbered}
...
In this example we demonstrate the basic functionality of the package on the `r ref("datasets::faithful", text = "faithful")` data from the `r mlr3book::cran_pkg("datasets")` package.
This task ships as pre-defined `r ref("TaskDens")` with `r mlr3book::mlr_pkg("mlr3proba")`.
