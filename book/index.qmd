...
To reference the `r ref_pkg("mlr3")` package, please cite our JOSS paper:
...
We highly recommend to take a look at our `r ref_pkg("cheatsheets")` while diving deeper into `r ref_pkg("mlr3")`.
::: -->
