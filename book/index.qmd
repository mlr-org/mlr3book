...
tuned_rf = auto_tuner(
    ...
    lrn("classif.randomForest", ntree = to_tune(200, 500)),
    rsmp("holdout")
)
...
* Links to GitHub, CRAN, mlr3 and others
...
To reference the `r mlr3book::mlr_pkg("mlr3")` package, please cite our JOSS paper:
...
Throughout this book we will use our own style guide that can be found in the Wiki of the mlr3 GitHub repo. We will not go into detail here but will highlight the most important style choices so this is clear when reading the book.
