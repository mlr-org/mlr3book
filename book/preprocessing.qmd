...
```{r preproc-00755, echo = TRUE, eval = TRUE, message=FALSE, error=TRUE}
...
```{r preproc-01355, echo = TRUE, eval = TRUE, message=FALSE, warning=FALSE}
#| label: fig-robustify
...
```{r preproc-01455, echo = TRUE, eval = TRUE, message=FALSE, warning=FALSE}
...
```{r preproc-0165, echo = TRUE, eval = TRUE, message=FALSE, warning=FALSE}
learners = list(
    baseline = baseline_lrn,
    tree = lrn("regr.rpart"),
    xgboost_impact = xgboost_impact,
