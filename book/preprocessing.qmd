...
It contains 81 features on various aspects of the house (basement, garage, size, fence, pool, porch, bedrooms, etc.), size and shape of the lot and information about condition and quality.
...
Looking at the data we can already see a few problems we should address before we proceed to modeling.
