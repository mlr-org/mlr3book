...
Most importantly, you can group the data with `by` and combine this with aggregating functions in `j`:
```{r}
dt[, mean(x), by = "y"]
```
There is also extensive support to perform all kind of data base join operations (see, e.g., [here](https://rstudio-pubs-static.s3.amazonaws.com/52230_5ae0d25125b544caab32f75f0360e775.html)).
