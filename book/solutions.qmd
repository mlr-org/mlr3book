...
at_xgboost = auto_tuner(
  method = tnr("random_search", batch_size = 1),
...
You can use any resampling method from `r mlr3spatiotempcv`, in this solution we use 4-fold spatial envrionmental blocking.
...
set.seed(11)
learners = lrns(paste0("classif.", c("xgboost", "featureless")), predict_type = "prob")
rsmp_sp = rsmp("spcv_env", folds = 4)
design = benchmark_grid(tsk("ecuador"), learners, rsmp_sp)
bmr = benchmark(design)
bmr$aggregate(msr("classif.bbrier"))[, c(5, 7)]
```
