...
The next two steps are to populate the registry with the experiments and to submit them.
...
After the execution of the experiment finished, we can collect the results.
