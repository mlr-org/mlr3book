# ROC Curve and Thresholds {#binary-roc .unnumbered}
...
For `r mlr3book::mlr_pkg("mlr3")` prediction objects, the ROC curve can easily be created with `r mlr3book::mlr_pkg("mlr3viz")` which relies on the `r mlr3book::cran_pkg("precrec")` to calculate and plot ROC curves:
