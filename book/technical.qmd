...
The `r ref("Tuner")` proposes a batch of `batch_size` hyperparameter configurations and creates `batch_size` learners (one learner parametrized for each proposed configuration).
