...
`r mlr3` includes two baseline learners: `classif.featureless`, which always predicts the majority class, and `lrn("regr.featureless")`, which always predicts the mean response (extension packages include task-specific baselines).
