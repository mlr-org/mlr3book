...
We welcome pull requests to any packages in our universe so if you have extended our universe with new classes and want to share them with the rest of our users, then please send us a message and we would be happy to help.
Full documentation for extending and customizing objects is covered in the documentation of the respective packages: `r ref_pkg("mlr3learners")` for classes inheriting from `Learner`, `r ref_pkg("mlr3pipelines")` for classes inheriting from `PipeOp`.
