...
```{mermaid}
%%| label: fig-parallel
%%| fig-cap: "Principle of parallel computing: A task consisting of multiple subtasks is spawned on 3 workers. The results are collected (and usually combined) in a second step."
graph LR
    M[fa:fa-server Main]
    S{Spawn}
    C{Collect}
    ...
    M --> S
    S -->|Task 1| W1[fa:fa-microchip Worker 1]
    S -->|Task 2| W2[fa:fa-microchip Worker 2]
    S -->|Task 3| W3[fa:fa-microchip Worker 3]
    W1 -->|Result 1| C
    W2 -->|Result 2| C
    W3 -->|Result 3| C
```
