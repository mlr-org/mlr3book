...
However, `r ref_pkg("future")` allows you to first chunk jobs together which combines multiple tasks into blocks which run sequentially on a worker, avoiding the intermediate synchronization steps.
:::
