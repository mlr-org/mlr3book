...
In practice, it is common to use 2/3 of the data as training set and 1/3 as test set for the holdout strategy as this provides a reasonable trade-off between bias and variance of the generalization performance estimate (see also Section 2.2 in @hpo_practical).
...
**TODO:** We will expand on benchmark experiments in more depth in chapter (insert ref).
