...
In essence, the process of holding back some portion of the data for evaluation simulates what is happening in practice with a deployed model: New data is gathered as time moves on, and the model has never seen it during training.
