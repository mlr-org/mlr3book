...
abstract: |
  (TODO) Estimating the generalization error of a machine learning algorithm on a given dataset requires   evaluation of data not used during training.
  Resampling refers to the process of repeatedly splitting available data in train- and test sets to   enable unbiased performance evaluation.
  ...
  We show how this can be achieved within the `mlr3` ecosystem, from the construction of benchmark designs to the statistical evaluation of the results.
---
