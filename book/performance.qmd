...
For `r mlr_pkg("mlr3")` prediction objects, the ROC curve can easily be constructed with `r mlr_pkg("mlr3viz")` which relies on the `r ref_pkg("precrec")` to calculate and plot ROC curves:
