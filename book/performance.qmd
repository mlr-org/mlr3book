...
This gives rise to different resampling (@sec-resampling) strategies encoding more complex strategies.
...
Resampling (@sec-resampling) is a methodology to construct training and test splits.
We cover how to
...
`r mlr3` includes the following predefined resampling strategies:
