...
Over time, new data is collected that was not known during the model training process.
The deployed model makes predictions based on this new data, and we trust that it will perform as well as the previously estimated performance.
...
::: {.callout-tip}
An overview of some common performance measures implemented in `r mlr3`, including a short description can also be found by following the link provided in the overview table under *Measures overview* in @sec-appendix-overview-tables.
