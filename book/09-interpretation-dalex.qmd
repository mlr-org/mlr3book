...
```{r 09-interpretation-dalex-001, echo=FALSE, fig.cap='Taxonomy of methods for model exploration presented in this chapter. Left part overview methods for instance level exploration while right part is related to dataset level model exploration.', out.width = '92%', fig.align='center'}
...
```{r 09-interpretation-dalex-002, message=FALSE, warning=FALSE}
library("DALEX")
...
```{r 09-interpretation-dalex-010, message=FALSE, warning=FALSE, echo=FALSE}
tmp = ingredients:::plot.feature_importance_explainer(fifa_vi, max_vars = 12, show_boxplots = FALSE)
```

```{r 09-interpretation-dalex-011, message=FALSE, warning=FALSE, fig.width=8, fig.height=4.5}
...
```{r 09-interpretation-dalex-012, message=FALSE, warning=FALSE}
...
```{r 09-interpretation-dalex-013, message=FALSE, warning=FALSE, fig.width=8, fig.height=8}
library("ggplot2")
plot(fifa_pd) +
...
```{r 09-interpretation-dalex-014, message=FALSE, warning=FALSE}
...
```{r 09-interpretation-dalex-015, message=FALSE, warning=FALSE, echo=FALSE}
tmp = iBreakDown:::plot.break_down(ronaldo_bd_ranger)
```

```{r 09-interpretation-dalex-016, message=FALSE, warning=FALSE, fig.width=8, fig.height=4.5}
...
```{r 09-interpretation-dalex-018, message=FALSE, warning=FALSE, fig.width=8, fig.height=8}
selected_variables = c("age", "movement_reactions",
  "skill_ball_control", "skill_dribbling")
