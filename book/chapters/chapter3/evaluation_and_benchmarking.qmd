...
The combined prediction object can, for example, be used to manually compute a micro-averaged performance estimate.
(But see @sec-resampling-exec on how to do micro-averaging more conveniently.)
