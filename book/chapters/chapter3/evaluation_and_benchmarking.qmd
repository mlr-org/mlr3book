...
include_multi_graphics("Figures/mlr3book_figures-3.svg", "Figures/mlr3book_figures-3.png")
```
...
include_multi_graphics("Figures/mlr3book_figures-4.svg", "Figures/mlr3book_figures-4.png")
```
...
include_multi_graphics("Figures/mlr3book_figures-6.svg", "Figures/mlr3book_figures-6.png")
```
...
In the above example where we used `tsk("penguins")`, there is a difference in the classification error between micro and macro methods because the dataset has 344 rows, which is not divisible by three, hence the test sets are not of an equal size.
:::
...
@fig-score-aggregate-resampling visualizes the relationship between `$score()` and `$aggregate()` for a small example based on the `tsk("penguins")` task.
...
include_multi_graphics("Figures/mlr3book_figures-5.svg", "Figures/mlr3book_figures-5.png")
```
...
#| fig-alt: "Three images, each shows a blue box with text 'Train' and white space around it with text 'Test'. Left (Iteration 1): blue box with green and red dots inside it and yellow dots outside it. Middle (Iteration 2): blue box with green and yellow dots inside it and red dots outside it. Right (Iteration 3): blue box with yellow and red dots inside it and green dots outside it."
include_multi_graphics("Figures/mlr3book_figures-7.svg", "Figures/mlr3book_figures-7.png")
```
...
include_multi_graphics("Figures/mlr3book_figures-8.svg", "Figures/mlr3book_figures-8.png")
```
