...
print(plt)
ggplot2::ggsave("fig-benchmark-box.png", dpi = 600)
```
...
ggplot2::ggsave("fig-roc.png", dpi = 600)
```
...
print(plt)
ggplot2::ggsave("fig-basics-roc-ranger.png", dpi = 600)
```
...
plt = plt + ggplot2::scale_color_grey()
print(plt)
ggplot2::ggsave("fig-basics-prc-ranger.png", dpi = 600)
```
...
print(plt1)
ggplot2::ggsave("fig-basics-fpracc-ranger.png", dpi = 600)
plt2 = autoplot(prediction, type = "threshold", measure = msr("classif.acc"))
plt2$layers[[1]]$aes_params$colour = "grey30"
print(plt2)
ggplot2::ggsave("fig-basics-fpracc-ranger-2.png", dpi = 600)
```
...
print(plt1)
ggplot2::ggsave("fig-basics-rocpr-ranger.png", dpi = 600)
plt2 = autoplot(rr, type = "prc")
plt2 = plt2 + ggplot2::scale_fill_grey() + ggplot2::scale_color_grey()
print(plt2)
ggplot2::ggsave("fig-basics-rocpr-ranger-2.png", dpi = 600)
```
...
ggplot2::ggsave("fig-basics-rocpr-bmr.png", dpi = 600)
```
