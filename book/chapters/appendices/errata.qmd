...
* Replaced the "Pima Indians Diabetes" data set in the exercises with the synthetic `diabetes` data set shipped with `mlr3`, because `mlbench` removed `PimaIndiansDiabetes2`.
