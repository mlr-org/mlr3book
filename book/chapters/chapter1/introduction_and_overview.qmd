...
As an alternative to installing packages in R, you can use pre-built Docker images from the `r link("https://github.com/mlr-org/mlr3docker", "mlr3docker")` repository.
These images provide ready-to-use environments with `mlr3` and its ecosystem already installed.
You can pull the images from `r link("https://hub.docker.com/u/mlrorg", "Docker Hub")`:
...
For more details, see the `r link("https://github.com/mlr-org/mlr3docker", "mlr3docker")` repository.
