...
In Part III we introduce `r mlr3pipelines`, which allows to implement complex ML workflows easily.
...
At the end of each part of the book we have included exercises for you to test yourself what you have learned; you can find the solutions to these exercises at `r link("https://mlr3book.mlr-org.com/solutions.html")`.
