...
```{r advanced_hyperparameter_specification_using_paradox-012}
...
```{r advanced_hyperparameter_specification_using_paradox-019, echo = FALSE, out.width="45%", fig.show = "hold", fig.width = 4, fig.height = 4}
...
#| fig-alt: "Three scatter plots showing 500 sampled points in a unit square. The 'random' design shows uneven clustering, the 'lhs' design shows more uniform coverage, and the 'sobol' design shows the most even coverage of the space."
#| layout: [[40, 40]]
par(mar=c(4, 4, 2, 1))
