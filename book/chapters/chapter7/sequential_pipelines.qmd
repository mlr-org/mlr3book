...
magick::image_write(fig, path = "fig-pipelines-basic-plot.png", format = "png", density = 600)
```
...
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-learnerpipeop.png", format = "png", density = 600)
```
