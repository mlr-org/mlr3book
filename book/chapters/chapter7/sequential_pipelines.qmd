...
design = benchmark_grid(tsk("diabetes"),
...
glrn_sample$train(tsk("diabetes"))
```
...
2. Train the learner created in the previous exercise on `tsk("diabetes")` and display the coefficients of the resulting model.
