...
BB: we need to check where this is optimally placed
BB: we also want to inlude predict sets and explain how ppl can access and work with the training error
...
BB: why do we call it 'divide' here? isnt this confusing if 'partition' also exists? is this used internally?
...
BB: maybe move pipelines to the end?
...
BB: ist das nicht komisch und gefährlich?
...
BB: hier sollten wir auch was zum archiv kurz sagen
...
## Conclusion
BB: haben wir diese conclusion immer? ist es ein neues chapter? strukturvrgleich.
haben wir noch sachen vergessen?
