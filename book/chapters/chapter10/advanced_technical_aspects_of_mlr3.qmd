...
For this reason, the `batch_size` parameter defaults to `1` so that all `r ref("Terminator")`s work as intended, i.e., you cannot exceed the computational budget and draw wrong conclusions while comparing tuning algorithms.
