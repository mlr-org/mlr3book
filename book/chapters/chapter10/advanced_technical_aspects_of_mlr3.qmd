...
* `"mlr3/core"` -- Child logger for the core `r ref_pkg("mlr3")` package.
* `"mlr3/bbotk"` -- Child logger for `r ref_pkg("bbotk")`, also used by `r mlr3tuning` and `r mlr3fselect`.
* `"mlr3/mlr3pipelines"` -- Child logger for `r ref_pkg("mlr3pipelines")`.
