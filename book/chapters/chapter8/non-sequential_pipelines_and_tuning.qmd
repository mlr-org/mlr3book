...
Therefore, parallelization is often required in practice (@sec-parallelization) and/or more efficient tuning methods for searching large search spaces such as `r index('Bayesian optimization')` (@sec-bayesian-optimization.)
