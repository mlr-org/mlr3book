...
graph$plot(horizontal = TRUE)
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-parallel-plot.png", format = "png", density = 600)
```
...
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-pcascale.png", format = "png", density = 600)
```
...
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-selectnop.png", format = "png", density = 600)
```
...
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-bagginggraph.png", format = "png", density = 600)
```
...
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-stackinggraph.png", format = "png", density = 600)
```
...
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-branchone.png", format = "png", density = 600)
```
...
invisible(dev.off())
fig = magick::image_trim(fig)
magick::image_write(fig, path = "fig-pipelines-branchtwo.png", format = "png", density = 600)
```
...
autoplot(instance)
ggplot2::ggsave("05-pipelines-branch-03-prep.png", dpi = 600)
```
...
print(plt)
ggplot2::ggsave("fig-nonseq-instance.png", dpi = 600)
```
...
autoplot(instance)
ggplot2::ggsave("fig-tunefilter.png", dpi = 600)
```
