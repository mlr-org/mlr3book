...
#| fig-alt: PipeOp.
#| echo: false
include_multi_graphics("mlr3book_figures-21")
```
...
grid = benchmark_grid(tsk("sonar"),
  c(glrn_bagging, lrn_rpart, lrn("classif.ranger")), rsmp("cv", folds = 3))
bmr = benchmark(grid)
...
```{r}
glrn_tuned = auto_tuner(tnr("random_search"), graph_learner, rsmp("holdout"),
  term_evals = 10)
