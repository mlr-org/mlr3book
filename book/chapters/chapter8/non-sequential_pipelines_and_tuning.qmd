...
In this example, we use a classification tree\index{decision tree}, `r index('k-nearest-neighbors')` (KNN)\index{KNN|see{K-nearest-neighbors}}, and a regularized GLM\index{GLM}.
