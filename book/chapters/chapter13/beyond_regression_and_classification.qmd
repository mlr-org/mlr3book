...
print(plt)
ggplot2::ggsave("fig-costsens-threshold.png", dpi = 600)
```
...
ggplot2::ggsave("fig-censoring.png", dpi = 600)
```
...
p
ggplot2::ggsave("fig-autokm.png", dpi = 600)
```
...
ggplot2::ggsave("fig-dens-hist.png", dpi = 600)
```
...
print(plt)
ggplot2::ggsave("fig-beyond-density.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-clust-ruspini.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-clust-ruspini-estimated.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-clust-dend.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-clust-spirals.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-clust-spirals-pred.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-clust-usarrests.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-clust-sil.png", dpi = 600)
```
...
ggplot2::ggsave("fig-autocorrelation.png", dpi = 600)
```
...
ggplot2::ggsave("fig-sprsmp.png", dpi = 600)
```
...
ggplot2::ggsave("fig-beyond-raster.png", dpi = 600)
```
