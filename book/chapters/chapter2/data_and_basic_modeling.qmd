...
@tbl-parameters-classes lists the possible hyperparameter types, all of which create `r ref("Domain")` objects.

| Hyperparameter Class | Hyperparameter Type                |
| -------------------  | ---------------------------------- |
| `r ref("p_dbl", index = TRUE)`  | Real-valued (numeric)   |
| `r ref("p_int", index = TRUE)`  | Integer                 |
| `r ref("p_fct", index = TRUE)`  | Categorical (factor)    |
| `r ref("p_lgl", index = TRUE)`  | Logical / Boolean       |
| `r ref("p_uty", index = TRUE)`  | Untyped                 |
