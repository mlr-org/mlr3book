...
The output above is a `r ref("ParamSet", aside = TRUE)` object, supplied by the `r ref_pkg("paradox")` package. A more detailed introduction of the `paradox` package is provided in (@sec-paradox).
