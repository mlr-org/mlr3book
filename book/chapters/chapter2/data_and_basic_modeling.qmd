...
ggplot2::ggsave("fig-mtcars.png", dpi = 600)
```
...
autoplot(prediction)
ggplot2::ggsave("fig-basics-truthresponse.png", dpi = 600)
```
...
ggplot2::ggsave("fig-penguins-overview.png", dpi = 600)
```
...
print(plt)
ggplot2::ggsave("fig-basics-classlabels.png", dpi = 600)
```
...
print(plt)
ggplot2::ggsave("fig-basics-classlabels-german.png", dpi = 600)
```
...
ggplot2::ggsave("fig-zoopreds.png", dpi = 600)
```
