...
Note that learners already have dependencies defined in their parameter sets.
When using `r ref("to_tune()")` tokens, these dependencies are automatically preserved in the search space without needing to specify them manually.
