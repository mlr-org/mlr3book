...
This function allows us to *mark* the hyperparameter as requiring tuning in the specified range. Further information on the `r ref("to_tune()")`-function can be found in a later chapter (@sec-paradox-creation-tuning-paramset-from-learner).
...
More information on advanced hyperparameter specifications using the `paradox`-package will be given in a later chapter (@sec-paradox).
