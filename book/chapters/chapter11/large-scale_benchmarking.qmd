...
library(batchtools)
library(mlr3oml)
manual_path = normalizePath(file.path("..", "..", "openml", "manual"))
if (!dir.exists(manual_path)) {
  dir.create(manual_path, recursive = TRUE)
}
options(mlr3oml.cache = normalizePath(file.path("..", "..", "openml", "cache")))
```
...
```{r}
#| include: false
path_odatasets = normalizePath(file.path("..", "..", "openml", "manual", "odatasets_filter.rds"))
```
...
```{r}
#| include: false
path_adult_tasks = normalizePath(file.path("..", ".." "openml", "manual", "adult_tasks.rds"))
```
...
```{r}
#| include: false
path_otask_collection = normalizePath(file.path("..", "..", "openml", "manual", "otask_collection99.rds"))
```
...
```{r}
#| include: false
path_binary_cc18 = normalizePath(file.path("..", "..", "openml", "manual", "binary_cc18.rds"))
```
