...
Interpretation methods can be used to 'peek' inside these models to understand how data features are being used to make predictions.
...
It is generally recommended to repeat the permutation process and aggregate performance differences over multiple repetitions to decrease randomness in results.
