...
importance$plot()
```
<!-- FIXME: RS REWRITE ALT-TEXT BELOW --> 
```{r}
#| fig-height: 3
#| label: fig-iml-pfi
...
If we do not restrict ourselves to a fixed dataset then many possible counterfactual data points can exist as there are many ways to achieve a desired prediction.
