...
As a running example throughout this chapter, we will consider an gradient boosting machine (GBM) fit on half the features in the `"german_credit"` task.
...
Obviously, the error bars are most useful if the number of repetitions is sufficiently high as they refer to the 5% and 95% quantiles of the importance values.
:::
