...
print(plt)
ggplot2::ggsave("fig-iml-pfi.png", dpi = 600)
```
...
effect = FeatureEffect$new(predictor, feature = "amount",
  method = "pdp+ice")
effect$plot()
ggplot2::ggsave("fig-iml-pdice.png", dpi = 600)
```
...
#| label: fig-iml-surro
tree_surrogate$plot()
ggplot2::ggsave("fig-iml-surro.png", dpi = 600)
```
...
shapley = Shapley$new(predictor, x.interest = Charlie,
  sample.size = 1000)
shapley$plot()
ggplot2::ggsave("fig-iml-shapley.png", dpi = 600)
```
...
ggplot2::ggsave("fig-cf-mocfreq.png", dpi = 600)
```
...
ggplot2::ggsave("fig-cf-mocsurface.png", dpi = 600)
```
...
print(plt)
ggplot2::ggsave("fig-dalex-roc.png", dpi = 600)
```
...
plt = plt + ggplot2::scale_color_grey()
print(plt)
ggplot2::ggsave("fig-dalex-featimp.png", dpi = 600)
```
...
plt$layers[[1]]$aes_params$colour = "grey30"
print(plt)
ggplot2::ggsave("fig-dalex-pdp.png", dpi = 600)
```
...
ggplot2::ggsave("fig-dalex-breakdown.png", dpi = 600)
```
...
plot(predict_parts(gbm_exp, new_observation = Charlie, type = "shap"),
  show_boxplots = FALSE)
ggplot2::ggsave("fig-dalex-shaps.png", dpi = 600)
```
...
ggplot2::ggsave("fig-dalex-ice.png", dpi = 600)
```
