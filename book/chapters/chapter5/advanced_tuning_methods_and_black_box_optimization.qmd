...
ggplot(as.data.table(instance$archive), aes(x = selected_features, y = classif.ce)) +
  ...
  geom_point(
    ...
    stroke = 0.5) +
  theme_minimal()
ggplot2::ggsave("fig-pareto.png", dpi = 600)
```
...
ggplot2::ggsave("fig-bayesian-optimization-sinusoidal.png", dpi = 600)
```
...
ggplot2::ggsave("fig-bayesian-optimization-designsl.png", dpi = 600)
```
...
ggplot(xydt, mapping = aes(x = x, y = y)) +
  ...
  theme_minimal()
ggplot2::ggsave("fig-bayesian-optimization-ei.png", dpi = 600)
```
...
ggplot2::ggsave("fig-bayesian-optimization-sampling.png", dpi = 600)
```
...
ggplot(aes(y = classif.tpr, x = classif.fpr),
  ...
  geom_point(
    ...
    stroke = 0.5) +
  theme_minimal()
ggplot2::ggsave("fig-pareto-bayesopt.png", dpi = 600)
```
