...
Use either a Gaussian process (`lrn("regr.km")`) or a random forest (`lrn("regr.ranger")`) as the surrogate model and compare the anytime performance of these two BO algorithms.
