...
This is typically called dummy\index{dummy encoding|see{encoding, treatment}} or treatment encoding\index{encoding!treatment} and is required if the learner is a generalized linear (GLM) or additive model (GAM) model\index{generalized linear model}.
...
#| echo: false
plt = .Last.value
plt$layers[[1]]$aes_params$fill = "grey30"
plt$patches$plots[[1]]$layers[[1]]$aes_params$fill = "grey30"
print(plt)
```
