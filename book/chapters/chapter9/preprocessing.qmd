...
glrn_xgb_impact = as_learner(factor_pipeline %>>% xgboost)
glrn_xgb_impact$id = "XGB_enc_impact"

glrn_xgb_one_hot = as_learner(po("encode") %>>% xgboost)
...
glrn_log_lm_robust = as_learner(ppl("targettrafo", graph = lm_robust,
