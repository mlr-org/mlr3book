...
5. We denote packages, fields, methods, and functions as follows:
    ...
    * [`package`]{.refpkg} - With link (if online) to package CRAN, R-Universe, or GitHub page
    * [`package::function()`]{.refpkg} (for functions _outside_ the mlr-org ecosystem)
    * [`function()`]{.refcode} (for functions _inside_ the mlr-org ecosystem)
