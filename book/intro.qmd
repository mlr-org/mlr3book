...
These chapters are essential to understanding the core infrastructure of ML in mlr3.
We recommend that all readers study these chapters to become familiar with basic mlr3 terminology, syntax, and style.
@sec-optimization, @sec-feature-selection, @sec-pipelines, and @sec-preprocessing contain more advanced implementation details and more complex concepts and algorithms.
