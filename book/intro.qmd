...
The `r mlr_pkg("mlr3")` [@mlr3] package and ecosystem provide a generic, object-oriented, and extensible framework for [classification](#tasks), [regression](#tasks), [survival analysis](#survival), and other machine learning tasks for the R language [@R] (task types discussed in detail in Chapter 2.1.1).
...
Examples of this advanced functionality include [hyperparameter tuning](#tuning)(Chapter 4) and [feature selection](#fs)(Chapter 5).
[Parallelization](#parallelization) of many operations is natively supported (Chapter 7.1).
