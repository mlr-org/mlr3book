...
These are stored in an R6 `r ref("Dictionary")` (a key-value store) named `r ref("mlr_tasks")`.
...
# method 1 (working with a list of column vectors):
task$col_roles$name = "rn"
task$col_roles$feature = setdiff(task$col_roles$feature, "rn")

# method 2 (working with a list of column roles):
task$col_roles_by_name$rn = "name"
