...
Fortunately, there already is a predefined measure `"Measure")` for this purpose: `"MeasureClassifCosts")`:
...
If we now call `"resample()"` or `"benchmark()"`, the cost-sensitive measures will be evaluated.
