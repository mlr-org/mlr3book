...
The new design and the integration of further and newly developed R packages (**R6**, **future**) makes `r mlr_pkg("mlr3")` much easier to maintain and use, and more performant compared to `r mlr_pkg("mlr")`.
