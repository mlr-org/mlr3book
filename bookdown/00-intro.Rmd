...
The new design and the integration of further developed R packages and features (**data.table**, **R6**, pipelines) makes `r mlr_pkg("mlr3")` much easier to maintain, easier to use, and more performant compared to `r mlr_pkg("mlr")`.
