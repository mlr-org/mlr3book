...
gr = Graph$new()$add_po("(pipeopdropconst"))
...
gr = Graph$new()$add_po("(pipeopscalealways"))
result_posa = gr$train(task)[[1]]

gr = Graph$new()$add_po("(pipeopscalealwayssimple"))
