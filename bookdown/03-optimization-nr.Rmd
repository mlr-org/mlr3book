...
Once reason is that the repeated evaluation of the model on test data could leak information about its structure into the model, what results in over-optimistic performance estimates. 
