...
Learners work in a two-stage procedure:
...
Similar to `r ref("mlr_tasks")`, the `r ref("Dictionary")` `r ref("mlr_learners")` can be queried for all learners registered by `mlr3` or one of its extension packages.
