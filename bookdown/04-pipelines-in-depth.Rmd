...
They can be constructed explicitly ("`po("pca")`") or retrieved from the `mlr_pipelines` collection: `po("pca")`.
...
gr$add_pipeop(po("subsample", param_vals = list(frac = 0.1)))
...
op_pca = po("pca", param_vals = list(center = TRUE))
op_pca$param_set$values
```
