...
The `r mlr_pkg("mlr3")` package and ecosystem provides a generic, object-oriented, and extensible framework for [classification](#cost-sens), regression, [survival analysis](#survival), and other machine learning tasks for the R language.
