...
Functional data is data that consists of curves varying over a continuum e.g. time, frequency or wavelength.
...
Multilabel analysis deals with objects that can belong to more than one category at the same time.
...
This sub-chapter deals with the implementation of cost sensitive analysis.
