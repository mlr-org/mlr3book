...
The section on special tasks explores the different functions of mlr3, when dealing with specific data sets that require further statistical modification to undertake sensible analysis.

This chapter will illustrate on how to deal with the following topics:

##Survival Analysis 

Survival analysis is used to monitor the period of time until a specific event takes places.
...
One cannot use a ordinary regression analysis when dealing with survival analysis data sets.
