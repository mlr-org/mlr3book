...
Two rudimentary considerations are important when conducting [survival analysis](#survival):
...
Firstly, this sub-chapter provides guidance on how to implement a first model.
Subsequently, instructions on how to modify cost sensitivity measures, thresholding and threshold tuning follow.
