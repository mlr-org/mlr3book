...
```{r setup-02, include = FALSE, comment="", results="asis"}
library(fansi)
...
```{r 02-building-blocks-16, comment="", results="asis"}
...
Task methods `.$set_col_role()` and `s.$et_row_role()` change the view on the data and can be used to subset the task.
