...
* the search space
* the [optimization algorithm](#tuning-optimization) (aka tuning method)
* an evaluation method, i.e., a resampling strategy and a performance measure

In summary, the sub-chapter on [tuning](#tuning) illustrates [hyperparameter selection](#tuning), how to pick an [optimizing algorithm](#tuning-optimization) and how to [automate tuning](#autotuner) using mlr3.
...
* Feature selection using [variable importance filters](#fs-var-imp-filter)
...
* The [evaluation](#nested-resamp-eval) of executed resampling interations

The sub-section [nested resampling](#nested-resampling) will provide instructions on how to implement nested resampling, accounting for both inner and outer resampling.
