...
In summary, the sub-chapter on tuning illustrates [hyperparameter selection](#tuning), how to pick an [optimizing algorithm](#tuning-optimization) and how to [automate tuning](#autotuner) using mlr3.
