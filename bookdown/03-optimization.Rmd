...
In summary, the sub-chapter on [tuning](#tuning) illustrates (1) empirically sound [hyperparameter selection](#tuning), (2) the selection of the [optimizing algorithm](#tuning-optimization) and (3) how to [automate tuning](#autotuner) using mlr3.
