...
In summary, the sub-chapter on [tuning](#tuning) illustrates (1) how to undertake empirically sound [hyperparameter selection](#tuning), (2) how to select the [optimizing algorithm](#tuning-optimization) and (3) how to [automate tuning](#autotuner) using mlr3.
...
The model has seen these observations already during the tuning process.
