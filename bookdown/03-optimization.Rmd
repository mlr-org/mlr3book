...
In summary, the sub-chapter on tuning illustrates how to undertake hyperparameter selection, pick an optimizing algorithm and automate tuning using mlr3.
...
knitr::include_graphics("images/tuning_process.png")
```
...
```{r 03-optimization-014, echo = FALSE, out.width="98%"}
knitr::include_graphics("images/feature_selection.png")
```
The objective of feature selection is to fit the sparse dependent of a model on a subset of available data features in the most suitable manner.
