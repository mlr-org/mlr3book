...
This includes creating supervised machine learning tasks like classification and regression, training models and getting prediction on new data, and evaluating and comparison of different models through cross-validation and benchmarking.
...
We will cover more complex workflows that allow to do this and much more later, but restrict ourselves to simple workflows like the one above here for the sake of clarity.
