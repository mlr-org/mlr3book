...
# compare via 10-fold cross validation resamplings = mlr_resamplings$mget("cv")
...
t = mlr3misc::rowwise_table(
  ...
  "General / Helper", "downsample()",                     "---",                 "---",
  "General / Helper", "extractFDAFPCA()",                 "---",                 "---",
  "General / Helper", "extractFDAFourier()",              "---",                 "---",
  "General / Helper", "extractFDAMultiResFeatures()",     "---",                 "---",
  "General / Helper", "extractFDAWavelets()",             "---",                 "---",
  "General / Helper", "generateCalibrationData()",        "---",                 "---",
  "General / Helper", "generateCritDifferencesData()",    "---",                 "---",
  "General / Helper", "generateFilterValuesData()",       "---",                 "---",
  "General / Helper", "generateLearningCurveData()",      "---",                 "---",
  "General / Helper", "generatePartialDependenceData()",  "---",                 "---",
  "General / Helper", "generateThreshVsPerfData()",       "---",                 "---",
  "General / Helper", "getCaretParamSet()",               "---",                 "---",
  "General / Helper", "impute()",                         "---",                 "---",


  "Task", "Task",                                 "mlr_tasks / Task",           "---",
  "Task", "SurvTask",                             "mlr3survival::TaskSurv",     "---",
  "Task", "ClusterTask",                          "mlr_tasks",                  "---",
  "Task", "MultilabelTask",                       "mlr_tasks",                  "---",
  "Task", "SpatialTask",                          "Not yet implemented",        "---",
  "Task", "Example tasks (iris.task,              mtcars.task)",                "mlr_tasks$get('iris')", "---",
  "Task", "convertMLBenchObjToTask()",            "---",                        "---",
  "Task", "dropFeatures()",                       "Task$select()",              "---",
  "Task", "getTaskCosts()",                       "---",                        "---",
  "Task", "getTaskData()",                        "Task$data()",                "---",
  "Task", "getTaskDesc() / getTaskDescription()", "---",                        "---",
  ...
  "Train/Predict/Resample", "Aggregation / makeAggregation",                "",                     "---",
  "Train/Predict/Resample", "asROCRPrediction()",                           "",                     "---",
  "Train/Predict/Resample", "getConfMatrix() / calculateConfusionMatrix()", "",                     "---",
  "Train/Predict/Resample", "calculateROCMeasures()",                       "",                     "---",
  "Train/Predict/Resample", "estimateRelativeOverfitting()",                "",                     "---",
  "Train/Predict/Resample", "estimateResidualVariance()",                   "",                     "---",
  ...
  "Benchmark", "convertBMRToRankMatrix()",                                          "",                                 "---",
  "Benchmark", "convertMLBenchObjToTask()",                                         "",                                 "---",
  "Benchmark", "getBMRAggrPerformances()",                                          "BenchmarkResult$aggregated()",     "---",
  "Benchmark", "getBMRFeatSelResults()",                                            "",                                 "---",
  "Benchmark", "getBMRFilteredFeatures()",                                          "",                                 "---",
  ...
  "Benchmark", "getBMRTuneResults()",                                               "",                                 "---",
  "Benchmark", "friedmanTestBMR()",                                                 "",                                 "---",
  "Benchmark", "mergeBenchmarkResults()",                                           "BenchmarkResult$combine()",        "---",
  "Benchmark", "plotBMRBoxplots()",                                                 "",                                 "---",
  "Benchmark", "plotBMRRanksAsBarChart()",                                          "",                                 "---",
  "Benchmark", "plotBMRSummary()",                                                  "",                                 "---",
  "Benchmark", "plotResiduals()",                                                   "",                                 "---",

  "Parameter Specification", "ParamHelpers::makeNumericParam()",  "ParamDbl$new()",          "Pkg: paradox",
  "Parameter Specification", "ParamHelpers::makeIntegerParam()",  "paradox::ParamInt$new()", "Pkg: paradox",
  "Parameter Specification", "ParamHelpers::makeDiscreteParam()", "paradox::ParamFct$new()", "Pkg: paradox",
  "Parameter Specification", "ParamHelpers::makeLogicalParam()",  "paradox::ParamLgl$new()", "Pkg: paradox",
  ...
  "Feature Selection", "makeFeatSelControlExhaustive()", "",             "",
  "Feature Selection", "makeFeatSelControlRandom()",     "",             "",
  "Feature Selection", "makeFeatSelControlSequential()", "",             "",
  "Feature Selection", "makeFeatSelControlGA()",         "",             "",
  "Feature Selection", "makeFilter()",                   "Filter$new()", "",
  "Feature Selection", "FeatSelResult",                  "",             "",
  "Feature Selection", "listFilterMethods()",            "mlr_filters",  "",
  "Feature Selection", "analyzeFeatSelResult()",         "",             "",
  "Feature Selection", "getBMRFeatSelResults()",         "",             "",
  "Feature Selection", "getBMRFilteredFeatures()",       "",             "",
  "Feature Selection", "getFeatSelResult()",             "",             "",
  "Feature Selection", "getFeatureImportance()",         "",             "",
  "Feature Selection", "getFilteredFeatures()",          "",             "",
  "Feature Selection", "makeFeatSelWrapper()",           "",             "",
  "Feature Selection", "makeFilterWrapper()",            "",             "",
  "Feature Selection", "getResamplingIndices()",         "",             "",
  "Feature Selection", "selectFeatures()",               "",             "",
  "Feature Selection", "filterFeatures()",               "",             "",
  "Feature Selection", "generateFilterValuesData()",     "",             "",
  "Feature Selection", "",                               "",             "",

  "Tuning", "getTuneResult()",        "", "",
  "Tuning", "getTuneResultOptPath()", "", "",

  "Parallelization", "ParallelMap::parallelStart*(), parallelMap::parallelStop()", "future::plan() / future", "",
  "Parallelization", "",                             "",                           "",

  "Plotting", "plotBMRBoxplots()",         "", "",
  "Plotting", "plotBMRRanksAsBarChart()",  "", "",
  "Plotting", "plotBMRSummary()",          "", "",
  "Plotting", "plotCalibration()",         "", "",
  "Plotting", "plotCritDifferences()",     "", "",
  "Plotting", "plotFilterValues()",        "", "",
  "Plotting", "plotHyperParsEffect()",     "", "",
  "Plotting", "plotLearnerPrediction()",   "", "",
  "Plotting", "plotLearningCurve()",       "", "",
  "Plotting", "plotPartialDependence()",   "", "",
  "Plotting", "plotResiduals()",           "", "",
  "Plotting", "plotROCCurves()",           "", "",
  "Plotting", "plotThreshVsPerf()",        "", "",
  "Plotting", "plotTuneMultiCritResult()", "", ""
)
