...
The experiment conducted in the [train/predict/score](#train-predict) chapter is equivalent to a "holdout", so let's consider this one first.
...
setequal(rr1$resamplings[[1]]$train_set, rr2$resamplings[[1]]$train_set)
```
...
t = mlr3misc::rowwise_table(
  ...
  "Train/Predict/Resample", "getConfMatrix() / calculateConfusionMatrix()", "Not yet implemented",  "---",
