...
Other packages that provide, to varying degree, some preprocessing functionality or machine learning domain specific language, are the `r cran_pkg("caret")` package and the related `r cran_pkg("recipes")`  project, and the `r cran_pkg("dplyr")` package.
