...
```{r 06-parallelization-001, eval = FALSE}
...
```{r 08-error-handling-003, error = TRUE}
task = mlr_tasks$get("spam")
learner = mlr_learners$get("classif.debug")
...
```{r 08-error-handling-006, error = TRUE}
e$predict()
```
