...
classoption: [12pt,parskip=half, DIV=calc, BCOR=10mm, x11names]
...
# pinp options for PDF output
one_column: true
numbersections: true
footer_contents: "mlr3book"
fontsize: 11pt
---
...
The code examples in this book use a few additional packages that are not installed by default if you install `mlr3`.
To run all examples in the book, install the `mlr-org/mlr3book` package using the `remotes` package:
