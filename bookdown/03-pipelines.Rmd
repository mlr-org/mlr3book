...
```{r 03-pipelines-029, fig.width=7.5}
...
```{r 03-pipelines-034, fig.width=7.5}
...
we can then add a learner to the Pipeop to obtain a learner equipped with automatic
imputation.

```{r 03-pipelines-038}
lrn = GraphLearner$new(poi %>% PipeOpLearner$new(mlr_learners$get("rpart")))
```
...
```{r 03-pipelines-042, fig.width=7.5, fig.height = 9}
