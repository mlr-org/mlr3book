...
We will most often use the term "Graph" in this manual but it can interchangeably used with "pipeline" or "workflow".
...
`mlr_pkg("mlr3featsel")` contains many different `Filters` that can be used to select features for subsequent learners.
