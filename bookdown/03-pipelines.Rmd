...
Other packages that provide, to varying degree, some preprocessing functionality or machine learning domain specific language, are the caret package and the related recipes project, and the [dplyr](https://dplyr.tidyverse.org/) package.
...
> and using these as new learning sets" (Breiman 1994)
