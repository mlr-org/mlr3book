...
An extensive introduction to creating custom **PipeOps** (PO's) can be found in the [technical introduction](#extending-pipes).
...
```{r 03-pipelines-023}
(graph %>>% mlr_pipeops$get("unbranch", c("null", "pca", "scale")))$plot(html = TRUE) %>%
  visInteraction(zoomView = FALSE) # disable zoom
```
