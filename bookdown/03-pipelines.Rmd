...
`r mlr_pkg("mlr3pipelines")` is a dataflow programming toolkit for machine learning in R utilizing the `r mlr_pkg("mlr3pipelines")` package. A more in-depth and technically oriented vignette can be found in the [mlr3pipeline vignette](https://mlr3pipelines.mlr-org.com/articles/introduction.html).
