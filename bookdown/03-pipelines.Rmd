...
```{r 03-pipelines-000, echo = FALSE, width = 10, height = 10}
library(visNetwork)
...
The figure below depicts an exemplary `PipeOp`: 
...
```{r 03-pipelines-030, fig.width=7.5}
...
```{r 03-pipelines-035, fig.width=7.5}
...
```{r 03-pipelines-043, fig.width=7.5, fig.height = 9}
