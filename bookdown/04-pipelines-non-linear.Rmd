...
```{r 04-pipelines-non-linear-010, echo=FALSE, fig.align='center', out.width="98%"}
...
```{r 04-pipelines-non-linear-013, fig.width=7.5}
...
```{r 04-pipelines-non-linear-015, echo=FALSE, fig.align='center', out.width="98%"}
