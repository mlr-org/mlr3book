...
We can now copy this operation 10 times using `r ref('ppl("greplicate")')` .
The `r ref('ppl("greplicate")')` allows us to parallelize many copies of an operation by creating a Graph containing `n` copies of the input Graph.
