...
A predecessor to this package is the `r cran_pkg("mlrCPO")` package, which works with mlr 2.x.
...
```{r 04-pipelines-029, echo=FALSE, fig.align='center', out.width="98%"}
...
```{r 04-pipelines-037, echo=FALSE, fig.align='center', out.width="98%"}
...
```{r 04-pipelines-040, fig.width=7.5}
...
```{r 04-pipelines-042, echo=FALSE, fig.align='center', out.width="98%"}
...
```{r 04-pipelines-0043, eval = FALSE}
...
```{r 04-pipelines-055, fig.width=7.5, fig.height = 9}
...
```{r 04-pipelines-074, fig.width = 8, fig.height = 8}
gr$plot(html = TRUE)
```
