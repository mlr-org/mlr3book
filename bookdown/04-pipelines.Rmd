...
In order to limit overfitting, we additionally do not predict on the original predictions of the learner.
...
Subsequently, the several parts are trained on each part of the data.
