...
This single path conceptually may be visualized as followed:
```{r 04-pipelines-032, echo=FALSE, fig.align='center', out.width="98%"}
...
Conceptually, this may look something like this:
