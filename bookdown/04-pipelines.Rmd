...
* Task sub-sampling for speed and outcome class imbalance handling
...
Conceptually, the process of be summarized as follows: 

```{r 04-pipelines-015, echo=FALSE, fig.align='center', out.width="98%"}
knitr::include_graphics("images/pipe_action.png")
```
...
```{r 04-pipelines-025, echo=FALSE, fig.align='center', out.width="98%"}
...
```{r 04-pipelines-030, echo=FALSE, fig.align='center', out.width="98%"}
...
```{r 04-pipelines-034, fig.width=7.5}
...
```{r 04-pipelines-036, echo=FALSE, fig.align='center', out.width="98%"}
...
```{r 04-pipelines-040, fig.width=7.5, eval = FALSE}
...
```{r 04-pipelines-046, echo=FALSE, fig.align='center', out.width="98%"}
knitr::include_graphics("images/train_predict.png")
```
...
```{r 04-pipelines-049, fig.width=7.5, fig.height = 9}
