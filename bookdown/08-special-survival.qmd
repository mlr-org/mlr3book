...
Finally we take a look at the `PipeOp`s implemented in `r mlr3book::mlr_pkg("mlr3proba")`, which are used for composition of predict types.
...
See `r mlr3book::mlr_pkg("mlr3pipelines")` for full tutorials and details on `PipeOp`s.
