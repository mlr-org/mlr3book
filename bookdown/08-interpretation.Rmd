...
`effect` defines the interpretation model by wrapping `Predictor`. After this is done the selected features can be plotted. In this example, all of the features provided by the `palmerpenguins` data set were used. 

The results are:
```{r feateff, echo=FALSE, fig.cap='Plot of the results from FeatureEffects. FeatureEffects computes and plots feature effects of prediction models',  fig.align='center'}
...
plot(shapley)
```
```{r shapley, echo=FALSE, fig.cap='Plot of the results from Shapley. $\\phi$ gives the increase or decrease in probabilty given the values on the vertical axis',  fig.align='center'}
...
effect$plot(features = c("bill_length_mm","bill_depth_mm", "flipper_length_mm", "body_mass_g", "body_mass_g","year"))
```
```{r featimp, echo=FALSE, fig.cap='Plot of the results from FeatureImp. FeatureImp visualizes the importance of features given the prediction model',  fig.align='center'}
...
```{r featimptest, echo=FALSE, fig.cap='FeatImp test data set', fig.align='center'}
knitr::include_graphics("images/featimptest.png")
```

```{r featimppred, echo=FALSE, fig.cap='FeatImp train data set',  fig.align='center'}
knitr::include_graphics("images/featimptrainneu.png")
```


```{r featefftest, echo=FALSE, fig.cap='FeatEffect test data set',  fig.align='center'}
knitr::include_graphics("images/featefftest.png")
```


```{r feateffreal, echo=FALSE, fig.cap='FeatEffect train data set', fig.align='center'}
