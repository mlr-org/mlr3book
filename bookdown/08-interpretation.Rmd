...
Depending on which batch of input is sampled into the train data set, the reader will either see under- or overfitting in the test set.
...
As with the case with `FeatureImp` the results here from the test set also show under-/ overfitting problems. This would be a good opportunity for the reader to attempt to resolve the under- or overfitting by playing with the amount of features and the amount of data used for both the test and train data sets. Be sure to not change the line `train_set = sample(task_peng$nrow, 0.8 * task_peng$nrow)` as it will randomly sample the data again.
