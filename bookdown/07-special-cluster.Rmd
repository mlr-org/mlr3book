...
However, prediction does not always make sense, e.g., for hierarchical clustering.
...
### Visualization
Cluster analysis in `r mlr_pkg("mlr3")` is integrated with `r mlr_pkg("mlr3viz")` which provides a number of useful plots.
