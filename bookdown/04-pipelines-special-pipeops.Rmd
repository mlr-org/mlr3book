...
pom = po("missind")
pon = po("imputehist", id = "imputer_num", param_vals = list(affect_columns = is.numeric))
pof = po("imputeoor", id = "imputer_fct", param_vals = list(affect_columns = is.factor))
imputer = pom %>>% pon %>>% pof
...
po("filter", mlr3filters::FilterInformationGain$new())
```
