...
One can investigate all resamplings which were undertaken, as they are stored in the archive of the `r ref("TuningInstance")` and can be accessed through `$data()` method:
