...
If you want to add a new learner, please start via `r gh_pkg("mlr-org/mlr3learnertemplate")`.
You can can click on "use this template" and create an operational fork of the repo which can then be used as the skeleton for your learner.

The following section should give insights on how a mlr3learner is constructed.

**The following should not be used for copy/paste!**
...
* `packages`: Set of required packages to call the learner.
