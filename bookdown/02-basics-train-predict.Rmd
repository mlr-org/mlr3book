...
The concept is demonstrated on a supervised classification using the `r ref("mlr_tasks_sonar", text = "sonar")` dataset and the `r ref("mlr_learners_classif.rpart", text = "rpart")` learner, which builds a singe classification tree.
...
# populate the dictionary with additional measures
library("mlr3verse")
