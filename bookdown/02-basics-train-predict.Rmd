...
The concept is demonstrated on a supervised classification using the `r ref("mlr3data::penguins")` dataset and the `r ref("mlr_learners_classif.rpart", text = "rpart")` learner, which builds a singe classification tree.
