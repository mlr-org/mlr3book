...
Hyperparameter tuning differentiates from parameter tuning as parameters are set prior to training. 
Other parameters on the other hand derive their values through training. 
