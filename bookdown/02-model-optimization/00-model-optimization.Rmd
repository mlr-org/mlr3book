...
The sub-chapter on feature selection introduces two distinct approaches to filtering, namely on the one hand "filtering" and on the other hand an approach referred to as "feature subset selection" or "Wrapper methods".

**Nested Resampling**
Various different resampling strategies exist, for example cross-validation and bootstrap, to mention just two popular approaches. The third sub-chapter will elaborate on how to implement nested resampling.
