...
`r mlr_pkg("mlr3hyperband")` automatically divides the budget parameters boundaries with its lower bound, ending up with a budget range starting again at `1`, like it is the case originally.
...
sampler = SamplerJointIndep$new(list(
  Sampler1DRfun$new(tune_ps$params$eta, function(n) rbeta(n, 2, 5)),
  Sampler1DCateg$new(tune_ps$params$booster, prob = c(0.2, 0.3, 0.5))
))
```
