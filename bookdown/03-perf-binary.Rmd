...
Alternatively, we can plot the Presision-Recall curve (PPV vs TPR).
...
PRC are preferred over ROC curves in imbalenced populations.

```{r 02-basics-binary-004}
# PPV vs TPR / Precision vs Recall
