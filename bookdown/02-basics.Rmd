...
Summed up, this chapter contains sub-chapters on the following supervised machine learning tasks:
...
* modify the [current hyperparameter values](#learners-predefined)
