...
This is done by simply modifying the field `$col_roles` which is a named list of vectors of column names (supported column roles can be found in the manual of `r ref("Task")`):
