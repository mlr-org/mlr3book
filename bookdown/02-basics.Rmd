...
Each time the process is repated, different train and test sets are [resampled](#resampling) from the original data set.
...
* access and select one of the predifined resampling strategies 
...
* converte specific benchmark objects to resample objects
