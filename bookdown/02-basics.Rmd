...
* [cross-validation](#benchmarking) and
* [benchmarking](#benchmarking) for the purpose of evaluating and comparing [learners](#learners)
...
The sub-chapter provides information on: 

* Different [task types](#task-types)
* How to create [various tasks](#tasks-creation)
* Which tasks are [predefined](#tasks-predefined) in `mlr3`
* How to use the [task's public fields and methods](#tasks-api) in a sound manner
...
[Train and predict](#train-predict) shows how to use [tasks](#tasks) and [learners](#learners) to train a model and predict on a new data set.
Furthermore, [Train and predict](#train-predict) provides further guidance on how to:
