...
How to modify and extend learners is covered in a supplemental [advanced technical section](#extending-learner).
...
Hence, we refer the reader to Section \@ref(extending-learner) and proceed with an overview of the interface of already implemented learners.
